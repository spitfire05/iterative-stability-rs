@group(0)
@binding(0)
var<storage, read_write> v_indices: array<vec2<f32>>; // this is used as both input and output for convenience
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    output[global_id.x] = mandelbrot(v_indices[global_id.x]);
}